...
fig.add_trace(go.Scatter(ohlcv,x='date', y='media',mode='lines',marker_color='#A9A9A9',showlegend=False,line=dict(width=0.5)),row=1, col=1)
# Bar trace for volumes on 2nd row without legend
fig.add_trace(go.Bar(ohlcv,x='date',y='volume',showlegend=False,marker_color='#ff0000'), row=2, col=1)
