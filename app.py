...
fig.add_trace(go.Scatter(x=ohlcv.date,labels=dict(y='Precio u$s'), y=ohlcv.media,mode='lines',marker_color='#A9A9A9',showlegend=False,line=dict(width=0.5)),row=1, col=1)
# Bar trace for volumes on 2nd row without legend
fig.add_trace(go.Bar(x=ohlcv.date,y=ohlcv.volume,labels=dict(y='Precio u$s'),showlegend=False,marker_color='#ff0000'), row=2, col=1)
